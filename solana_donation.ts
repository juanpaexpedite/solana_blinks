...
const DONATION_DESTINATION_WALLET =
  'E2Cv5V8zRpde6o8rdjhZT7FqXNn8osD7UkcFx7nufWuY';
const DONATION_AMOUNT_SOL_OPTIONS = [0.05, 0.1, 0.2];
...
> {
  const icon =
    'https://raw.githubusercontent.com/juanpaexpedite/solana_blinks/main/solama_summer_2024.png';
  const title = 'Donate to JPBonk';
  const description =
    'Solana Enthusiast | Support my new project with a donation.';
